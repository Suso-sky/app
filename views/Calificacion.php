...
require_once "../controllers/controllerGeneral.php";
    ...
    $nota = $obj->getObtenerNota($_POST['nota']);
    $estudiantes = $obj->getObtenerEstudiantesCalificacion($_POST['cod_cur']);
    $calificaciones = $obj->getAllCalificaciones();
?>
