...
<div class="table-container">
  <table class="data-table">
    ...
    <?php if($notas): ?>
      ...
      <center><button type="submit" style="padding-top:15px; border: none; background: none;"><i class="fa-solid fa-pen-to-square fa-2xl" style="color: #417ee6;"></i></button></center>
        </form></td>
      ...
      <center><button type="submit" style="padding-top:15px; border: none; background: none;"><i class="fa-solid fa-delete-left fa-2xl" style="color: #d91717;"></i></button></center>
        ...
        <td><form action="Calificacion.php" method="POST">
          <input type="hidden" name="nota" value="<?=$nota[3]?>">
          <input type="hidden" name="cod_cur" value="<?=$nota[4]?>">
      <center><button type="submit" style="padding-top:15px; border: none; background: none;"><i class="fa-solid fa-file fa-2xl" style="color: #e18c14;"></i></button></center>
        </form></td></tr> 
